module Displayable
  ...
  def display_welcome_message
    ...
    puts "For every round you win, you will get 1 point."\
         "If you reach 10 points you won the game."
  end
...
class Human < Player
  def set_name
    ...
    loop do
      ...
      get_name = gets.chomp
      break unless get_name.empty? || get_name.start_with?(' ')
